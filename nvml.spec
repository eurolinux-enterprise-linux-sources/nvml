...
Patch0:		aabd4d2-test-do-not-run-pool_lock-test-as-root.patch
Patch1:		cb2e8d2-test-limit-number-of-arenas-in-vmem_stats.patch
Patch2:		670e94e-pmempool-fix-mapping-type-in-pool_params_parse.patch
